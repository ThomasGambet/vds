<div class="formulaire">
    ...
    <div class="row mb-3">
        <div class="col-sm-6">
            <label for="challenge" class="mt-3 col-form-label">La course est-elle inscrite au challenge ? </label>
            <input type='checkbox' id='challenge'
                   data-group-cls="btn-group-sm" data-off-label="Non" data-on-label="Oui"/>
        </div>
        <div class="col-sm-6">
            <label for="label" class="mt-3 col-form-label">La course a-t-elle un label FFA ?</label>
